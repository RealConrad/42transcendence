...
export default class Game {
    constructor(canvas, vsAI = true) {
        ...
        this.player2 = vsAI
            ? new Player('AI', player2Paddle, new AIController(player2Paddle, this.ball, 5)) // 3rd parameter is the difficulty level of the AI. 1 is super dumb, 5 is tough, 10 is darksouls
            : new Player(
                'Player 2',
                player2Paddle,
